...
DATA_SCHEMA_V25_FIELDS = [
    ...
    "corridor_block_reason", "corridor_block_source",
    "first_blocking_distance_m", "first_block_x", "first_block_y",
    "first_block_age_ticks",
    ...
    "plan_valid", "plan_terminal", "plan_end_speed_mps",
    "plan_executed_speed_mps", "plan_points_xy",
...
PRIVILEGED_DIAGNOSTIC_FIELDS = [
    ...
    "effective_direction_token", "directive_terminal_stop", "directive_update_event",
